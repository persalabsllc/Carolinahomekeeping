...
- The owner-provided mailing address, **6210 Old US Hwy 70 W, New Bern, NC 28562**, is saved in production email settings and remains editable in Control Room → Emails. Public customer contact **252-515-4389** is centralized in `lib/business-contact.ts` and used by the Contact page, site footer, structured data and customer emails.
