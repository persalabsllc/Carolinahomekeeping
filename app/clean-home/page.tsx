...
export default async function CleanHome(){
  const [config,scheduling,availability]=await Promise.all([getConfig(),getScheduling(),getHomeAvailability()]);
  ...
  return <div className="ad-landing">
    ...
    <div className="ad-grid">
      ...
      <section id="your-clean" className="ad-form" aria-label="Get your instant cleaning price">
        <BookingFlow config={config} scheduling={scheduling} initial={{}} leadReady={readiness().database} campaign/>
      </section>
    </div>
