...
export function apiError(error:unknown,status=400){
 ...
 const publicMessage=/^Please |^Too many|^That appointment|^Your price|^Online booking|^Payment |^Move cleaning|^Empty cabinets|^No appointment|^Sign-in|^Invalid code|^This booking|^Cannot |^No matching|^That cleaning|^That time|^The reserved|^Capacity cannot|^Choose a valid|^This period|^This blocked|^No unscheduled|^This cleaning/.test(safe)?safe:'We couldn’t complete that request. Please check your details and try again.';
