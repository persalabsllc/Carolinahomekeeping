...
export const bookingSchema=quoteSchema.extend({contact:contactSchema,home:homeSchema,slotId:z.uuid(),policyAccepted:z.literal(true),policyVersion:z.literal('2026-09-19'),photoConsent:z.boolean().default(false)});
