...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="en"><body className={`${sans.variable} ${serif.variable}`}><Header/><main id="main">{children}</main><Footer/></body></html>;}
